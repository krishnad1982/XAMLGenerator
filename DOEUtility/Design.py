...
class Ui_GenerateXAML(object):
    def setupUi(self, GenerateXAML):
        ...
        self.gridLayout.addWidget(self.groupBox, 9, 0, 2, 1)
    ...
    def retranslateUi(self, GenerateXAML):
        ...
        self.txtSkinName.setPlaceholderText(_translate("GenerateXAML", "Enter Skin Name"))
